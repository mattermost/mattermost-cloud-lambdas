module github.com/mattermost/mattermost-cloud-lambdas/prometheus-dns-registration-service
...
require (
	...
	github.com/kubernetes-sigs/aws-iam-authenticator v0.3.1-0.20180620224557-d9bfef19b2b8
